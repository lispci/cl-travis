...
install_i386_arch() {
    ...
    sudo apt-get install -y libc6:i386 libc6-dev:i386 lib32stdc++-7-dev:amd64 libstdc++-7-dev:i386
}
...
ECL_TARBALL_URL1="https://cdn.cddr.org/ci/ecl-20.4.24-linux-amd64.tar.gz"
